                        ...
                        <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
                            <div class="d-table-cell align-middle">
                                ...
                                <div class="text-center mt-4">
                                    <h1 class="h2">Update Activity</h1>
                                </div>
                                        ...
                                        <div class="m-sm-3">
                                            <form action="{{ route('activities.update', $activity->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control form-control-lg" id="title" type="text" name="title" value="{{ $activity->title }}" required />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Description</label>
                                                    <textarea name="description" id="description" class="form-control form-control-lg" required>{{ $activity->description }}</textarea>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control form-control-lg" type="date" id="date" name="date" value="{{ $activity->date }}" required />
                                                </div>
